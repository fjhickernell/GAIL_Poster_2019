...
\title{GAIL: Guaranteed Automatic Integration Library} % Poster title

\author{Jagadeeswaran Rathinavel \and Xin Tong \and Kan Zhang  \and Sou-Cheng T.~Choi \and Yuhan Ding
\\[0.8ex] Lan Jiang \and Da Li \and Llu\'is Antoni Jim\'enez Rugama \and  Yizhi Zhang \and Xuan Zhou \and Fred J.~Hickernell} % Author(s)
...
\addtobeamertemplate{headline}{} 
{
	...
	\node [anchor=north west, inner sep=2cm] at (current page.north west) {\includegraphics[height=12cm]{logoGAIL2.png}}; 
	\end{tikzpicture} 
}
...
{
	\begin{tikzpicture}[remember picture,overlay] 
	\node [anchor=north east, inner sep=2cm] at (current page.north east) {\includegraphics[height=12cm]{iit_high_res.png}}; 
	\end{tikzpicture} 
}
...
\small{\rmfamily{Supported in part by grants NSF-DMS-1115392 and NSF-DMS-1522687.}} \\
